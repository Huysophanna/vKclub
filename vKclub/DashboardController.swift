...
extension DashboardController {
    ...
    func CheckUserLocation() -> String {
        ...
        if CLLocationManager.locationServicesEnabled() {
            ...
            if (locationManagers.location?.coordinate.longitude != nil) {
                let currentlocation_lat = Double((locationManagers.location?.coordinate.latitude)!)
                let currentlocation_long = Double((locationManagers.location?.coordinate.longitude)!)
