...
class MapController: UIViewController,GMSMapViewDelegate,CLLocationManagerDelegate{
    ...
    let markerLocation = [
        ...
        kiriromLocation(title: "waterfall One", location: CLLocationCoordinate2DMake( 11.3438,104.0348 ),dec: "A multipurpose building which is used for wall climbing during the day and as a movie screen night time at night.", zoom: 14),
